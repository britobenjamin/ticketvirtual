...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Creates buttery smooth scrolling — same as original site
  let smoother;
  if (ScrollSmoother) {
    smoother = ScrollSmoother.create({
      wrapper: '#smooth-wrapper',
      content: '#smooth-content',
      smooth: 1.5,           // Smoothing factor (higher = smoother)
  ...
  window.handleSignup = function() {
    ...
    if (email && email.value && email.value.includes('@')) {
      ...
      wrapper.innerHTML = '<div style="color:#b8ff4f;font-size:18px;font-weight:600;">Thank you. Your submission has been received.</div>';
    } else {
